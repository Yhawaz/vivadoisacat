...
HD_PWD='/home/yhawaz/lab3/lab3.runs/design_1_tristate_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_tristate_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_tristate_1_0.tcl
